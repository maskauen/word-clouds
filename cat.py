...
parrot_color = np.array(Image.open(os.path.join(d, "image.png")))
...
parrot_mask[edges > 1] = 255

# create wordcloud. A bit sluggish, you can subsample more strongly for quicker rendering
# relative_scaling=0 means the frequencies in the data are reflected less
# acurately but it makes a better picture
wc = WordCloud(background_color="black",max_words=2500, mask=parrot_mask, max_font_size=80, random_state=42, relative_scaling=0)
